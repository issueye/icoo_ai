...
<template>
  <section class="qq-chat-workspace qq-audit-workspace">
    ...
    <div class="qq-settings-body">
      <div class="qq-settings-card qq-audit-card">
        ...
        <div class="qq-audit-grid">
          <div class="qq-audit-list-panel">
            <div class="qq-audit-panel-title">事件列表</div>
          ...
          <div class="qq-audit-detail-panel">
            <div class="qq-audit-panel-title">事件详情</div>
