...
export const agentBridge = {
  ...
  getGatewayStatus: () => callOrMock('GetGatewayStatus', { status: 'gateway_connecting', summary: '等待网关连接', updatedAt: new Date().toISOString() }),
  getAppSettings: () => callOrMock('GetAppSettings', { gatewayBinaryPath: '' }),
  updateAppSettings: (payload) => callOrMock('UpdateAppSettings', payload ?? { gatewayBinaryPath: '' }, payload ?? { gatewayBinaryPath: '' }),
